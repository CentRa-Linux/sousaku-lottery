...
class Ui_MainWindow(object):
    ...
    def dolottery(self):
        if self.fn != "" and self.fn[0] != "":
            ...
            f.close()
            try:
                self.lt, wt = lottery.lottery(kh, "db.csv", self.pspin.value(), lottery.alpha2dec(self.cline4.text()), lottery.alpha2dec(self.d2line.text()), [self.g5aspin.value(), self.g5bspin.value(), self.g5cspin.value(), self.g5dspin.value(
                ), self.g6aspin.value(), self.g6bspin.value(), self.g6cspin.value(), self.g6dspin.value()], lottery.alpha2dec(self.cline1.text()), lottery.alpha2dec(self.cline2.text()), lottery.alpha2dec(self.cline3.text()), not self.fcheck.isChecked(), self.d2check1.isChecked(), self.d2check2.isChecked(), self.d2check3.isChecked())
                lottery.dbupdate(wt, "db.csv", 0, 1, 2)
                today = datetime.date.today()
                self.restext.setText(lottery.postprocess(self.lt, self.nlspin.value(), self.mline.text(),
